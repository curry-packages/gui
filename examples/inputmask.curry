...
widget (Person name1 fname1 uni1 city1 street1 nr1 zip1 country1) noe =
 ...
 where street,zip,name,fname,uni,city,nr,country,nrlab,
       ...
       next wp =    getPerson (+1) wp         >>= \person
                 ...
                 -> return $ (if number == (read noe_cont :: Int)
       ...
       getPerson f wp = readFile pFile >>= \fileconts ->
                        ...
                        getValue nrlab wp >>= \nrlab_cont ->
                        return $ persons !! (f (read nrlab_cont :: Int) -1)
       ...
       setPerson f (Person pname pfname puni pcity pstreet pnr pzip pcountry) wp =
          ...
          getValue nrlab wp >>= \nrlab_cont ->
          let number = f (read nrlab_cont :: Int) in
...
someCurryHeroes =
  [Person "Hanus" "Michael" "Christian-Albrechts-University" "Kiel" "Ohlshausener Straße" "40" "D-24098" "Germany",
   Person "Antoy" "Sergio" "Portland State University" "Portland, Oregon" "SW 4th Avenue" "1900" "OR 97207-0751" "USA",
   Person "Vidal Oriola" "Germán F. " "Universidad Politécnica" "Valencia" "Camino de Vera" "s/n" "E-46022" "Spain",
   Person "Huch" "Frank" "Christian-Albrechts-University" "Kiel" "Ohlshausener Straße" "40" "D-24098" "Germany",
   Person "Braßel" "Bernd" "Christian-Albrechts-University" "Kiel" "Ohlshausener Straße" "40" "D-24098" "Germany"]
